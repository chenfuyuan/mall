...
public class AttrGroupController {
    ...
    public R list(@RequestParam Map<String, Object> params,@PathVariable String categoryId){
        PageUtils page = attrGroupQueryService.queryPageByCategoryId(params, categoryId);
